...
export default function App(){
  return (<div>
    <nav className="sticky top-0 z-50 backdrop-blur bg-black/40 border-b border-white/10">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-4">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <Link to="/join" className="hover:underline">List your act</Link>
    ...
    <Routes>
      ...
      <Route path="/acts/:slug" element={<ActDetail/>}/>
      <Route path="/venues" element={<Venues/>}/>
      <Route path="/venues/:slug" element={<VenueDetail/>}/>
      <Route path="/admin" element={<Admin/>}/>
      <Route path="/login" element={<Login/>}/>
      <Route path="/join" element={<Join/>}/>
      <Route path="/business" element={<BusinessLeads/>}/>
    </Routes>
    <footer className="mt-10 border-t border-white/10 py-6 text-center text-white/60">© {new Date().getFullYear()} VenueHub</footer>
  </div>)
}